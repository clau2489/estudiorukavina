...
$mail->Body = "{$mensajeHtml} <br /><br />Contacto a través de su Página Web<br />"; // Texto del email en formato HTML
...
<!DOCTYPE html>
    ...
    $miresultado = '<br><br><br><br><h2 style="text-align: center">El servidor no responde en estos momentos, intente nuevamente</h2>
    				<a style="text-align: center" href="../index.html">Continuar navegando</a>';
}
echo $miresultado;